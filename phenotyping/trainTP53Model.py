...
tp53_data = np.load("data/tp53_annotations.npz")
X, Y = tp53_data["X"], tp53_data["Y"]
...
checkpoint_filepath = os.path.join("models","TP53Model.h5")
...
membrane_path = os.path.join("models","MembraneModel.h5")
model.load_weights(membrane_path)
...
pickle.dump(history.history,open(os.path.join("eval","tp53_history.pkl"),"wb"))
...
pickle.dump(output,open(os.path.join("eval","tp53_model_output.pkl"),"wb"))
pickle.dump(X_test,open(os.path.join("eval","tp53_X_test.pkl"),"wb"))
pickle.dump(Y_test,open(os.path.join("eval","tp53_Y_test.pkl"),"wb"))
